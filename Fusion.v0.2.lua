...
local Window = Bracket:Window({Name = "Fusion v0.2",Enabled = true,Color = Color3.new(1,0.5,0.25),Size = UDim2.new(0,496,0,496),Position = UDim2.new(0.5,-248,0.5,-248)}) do
    ...
    local Tab = Window:Tab({Name = "Main"}) do
        ...
        local PlayerSection = Tab:Section({Name = "Player",Side = "Left"}) do
            ...
            PlayerSection:Slider({Name = "WalkSpeed",Min = 0,Max = 200,Precise = 1,Value = 0,Callback = function(value)
        ...
        local CameraSection = Tab:Section({Name = "Camera",Side = "Right"}) do
            ...
            CameraSection:Slider({Name = "FieldOfView",Min = 0,Max = 120,Value = 0,Callback = function(value)
